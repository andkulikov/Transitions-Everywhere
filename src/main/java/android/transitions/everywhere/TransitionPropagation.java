 ...
 * in {@link android.transitions.everywhere.Transition#createAnimator(android.view.ViewGroup,
 * android.transitions.everywhere.TransitionValues, android.transitions.everywhere.TransitionValues)}.
 * A Transition such as {@link android.transitions.everywhere.Explode}
 * defaults to using {@link android.transitions.everywhere.CircularPropagation} and Views closer to the
...
public abstract class TransitionPropagation {
     ...
     * negative.
     */
    public abstract long getStartDelay(ViewGroup sceneRoot, android.transitions.everywhere.Transition transition,
                                       android.transitions.everywhere.TransitionValues startValues, android.transitions.everywhere.TransitionValues endValues);
     ...
     * {@link #getStartDelay(ViewGroup, android.transitions.everywhere.Transition,
     * android.transitions.everywhere.TransitionValues, android.transitions.everywhere.TransitionValues)}.
    ...
    /**
     * Returns the set of property names stored in the {@link android.transitions.everywhere.TransitionValues}
     * object passed into {@link #captureValues(android.transitions.everywhere.TransitionValues)} that
     ...
     * {@link android.transitions.everywhere.TransitionValues}.
     */
