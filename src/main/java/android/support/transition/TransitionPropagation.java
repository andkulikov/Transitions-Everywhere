 ...
 * in {@link android.support.transition.Transition#createAnimator(android.view.ViewGroup,
 * android.support.transition.TransitionValues, android.support.transition.TransitionValues)}.
 * A Transition such as {@link android.support.transition.Explode}
 * defaults to using {@link android.support.transition.CircularPropagation} and Views closer to the
 ...
 *
 * @see android.support.transition.Transition#setPropagation(TransitionPropagation)
 * @see android.support.transition.Transition#getEpicenter()
 */
public abstract class TransitionPropagation {
     ...
     * negative.
     */
    public abstract long getStartDelay(ViewGroup sceneRoot, android.support.transition.Transition transition,
     ...
     * {@link #getStartDelay(ViewGroup, android.support.transition.Transition,
     * android.support.transition.TransitionValues, android.support.transition.TransitionValues)}.
    ...
    /**
     * Returns the set of property names stored in the {@link android.support.transition.TransitionValues}
     * object passed into {@link #captureValues(android.support.transition.TransitionValues)} that
     ...
     * {@link android.support.transition.TransitionValues}.
     */
