...
import android.support.util.MatrixUtils;
...
public class ChangeTransform extends Transition {
    ...
    private static final Property<View, Matrix> ANIMATION_MATRIX_PROPERTY =
            new Property<View, Matrix>(Matrix.class, "animationMatrix") {
                ...
                public void set(View object, Matrix value) {
                    ViewCompat.setAnimationMatrix(object, value);
                }
            };
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (mReparent) {
            ...
            ViewCompat.transformMatrixToGlobal(parent, parentMatrix);
    ...
    private void createGhostView(final ViewGroup sceneRoot, TransitionValues startValues,
        ...
        ViewCompat.transformMatrixToLocal(sceneRoot, localEndMatrix);
        ...
        View ghostView = ViewCompat.addGhostView(view, sceneRoot, localEndMatrix);
        if (ghostView != null) {
        ...
        ViewCompat.setTransitionAlpha(view, 1);
    }
    ...
    private static class Transforms {
        ...
        public Transforms(View view) {
            ...
            translationZ = ViewCompat.getTranslationZ(view);
    ...
    private static class GhostListener extends Transition.TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            ViewCompat.removeGhostView(mView);
