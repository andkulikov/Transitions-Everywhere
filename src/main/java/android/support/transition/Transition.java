...
import android.support.util.Objects;
 ...
 * {@link android.support.transition.R.styleable#Slide}, and {@link android.support.transition.R.styleable#ChangeTransform}.
 */
...
public abstract class Transition implements Cloneable {
                ...
                if (animator != null) {
                    ...
                    if (animator != null) {
                        ...
                        AnimationInfo info = new AnimationInfo(view, getName(), this,
                                ViewCompat.getWindowId(sceneRoot), infoValues);
    ...
    boolean isValidTarget(View target) {
        ...
        if (mTargetNameExcludes != null && target != null && ViewCompat.getTransitionName(target) != null) {
    ...
    public void pause(View sceneRoot) {
        if (!mEnded) {
            ...
            if (sceneRoot != null) {
                Object windowId = ViewCompat.getWindowId(sceneRoot);
     ...
     * {@link #setEpicenterCallback(android.support.transition.Transition.EpicenterCallback)} to
     ...
     * @see #setEpicenterCallback(android.support.transition.Transition.EpicenterCallback)
     */
    public static abstract class EpicenterCallback {

        /**
         * Implementers must override to return the epicenter of the Transition in screen
         * coordinates. Transitions like {@link android.support.transition.Explode} depend upon
         ...
         * {@link android.support.transition.Fade} pay no attention to the epicenter.
         *
